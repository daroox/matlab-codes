...
FileName ='XSTRIPE_X_no_steps_110_XdistancebetweenSteps_80___no_steps_4_Y_distancebetween_steps_200.dat'; 
...
yy = 1:size(newY,2);
%% plotting
imagesc(B) 	% plot the rotated ! matrix
%colorbar	%show the colorbar
colormap(parula) % options parula,jet,hsv,hot,gray
%title(TITLE);
